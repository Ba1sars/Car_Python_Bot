...
def fetch_factory(marque_option, model_option, series_publish_year_option):
    ...
    # fetch marque
    if (
        marque_option == "marque"
        and model_option is None
    ...
    # fetch series and publish year
        ...
        and series_publish_year_option == "series_with_publish_year"
    ):
        cursor.execute(
    ...
    # fetch dashcam and photos
        ...
        marque_option is not None
        and model_option is not None
        and series_publish_year_option is not None
    ):
        cursor.execute(
